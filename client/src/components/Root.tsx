...
const SOCIAL_DEFS: { key: string; label: string; icon: JSX.Element }[] = [
  ...
  { key: "whatsapp",  label: "WhatsApp",  icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12.05 2.003c-5.517 0-9.997 4.48-9.997 9.997 0 1.762.462 3.483 1.34 5.003L2 22l5.166-1.354a9.96 9.96 0 004.883 1.24h.004c5.517 0 9.997-4.48 9.997-9.997 0-2.672-1.04-5.184-2.929-7.073a9.935 9.935 0 00-7.07-2.923zm0 18.163a8.15 8.15 0 01-4.153-1.14l-.298-.177-3.064.803.818-2.988-.194-.307a8.16 8.16 0 01-1.257-4.357c0-4.516 3.674-8.19 8.19-8.19 2.188 0 4.245.852 5.792 2.4a8.135 8.135 0 012.397 5.793c0 4.517-3.674 8.163-8.231 8.163z"/></svg> },
];
