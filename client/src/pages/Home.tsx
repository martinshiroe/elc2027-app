  ...
  return (
    <section id="hero" style={{ position: "relative", overflow: "hidden", background: "#0e0e0e", paddingTop: 120, paddingBottom: 80 }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 28px", position: "relative", textAlign: "center" }}>
        ...
        <h1 style={{ fontFamily: "'Audiowide', sans-serif", fontWeight: 400, fontSize: "clamp(28px, 4.6vw, 58px)", lineHeight: 1.35, letterSpacing: "0.005em", color: "#fff", margin: "0 auto 24px", maxWidth: 980, textWrap: "balance" as any }}>
